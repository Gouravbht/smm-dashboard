...
import { Search, ChevronRight, ChevronDown, Settings, HelpCircle, Bell, Moon, Sun, Download, Menu, X, Sparkles, Loader2, FileText, FileSpreadsheet, FileDown } from "lucide-react";
    ...
    <header className="flex items-center gap-2 sm:gap-3 px-3 sm:px-6 h-14 border-b border-border bg-background sticky top-0 z-30 shrink-0">
      ...
      <div ref={exportRef} className="relative shrink-0">
        <button
          ...
          className={cn(
            "h-8 px-2.5 flex items-center gap-1.5 rounded-lg text-[11px] font-medium transition-colors",
            exportOpen
              ? "bg-indigo-50 dark:bg-indigo-500/15 border border-indigo-200 dark:border-indigo-500/30 text-indigo-600 dark:text-indigo-400"
        ...
        {exportOpen && (
          <div className="absolute top-full right-0 mt-1.5 w-48 rounded-xl border border-border bg-popover shadow-xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-150">
            <div className="px-3 py-2 border-b border-border">
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Export Report</p>
            </div>
            <div className="p-1">
              <button
              ...
              >
                <div className="w-7 h-7 rounded-md bg-red-50 dark:bg-red-500/10 flex items-center justify-center shrink-0">
                  <FileText className="w-3.5 h-3.5 text-red-500" />
                </div>
                <div>
                  <p className="text-[12px] font-semibold text-foreground">PDF Report</p>
                  <p className="text-[10px] text-muted-foreground">Full report · 4 pages</p>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-muted transition-colors text-left"
              >
                <div className="w-7 h-7 rounded-md bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center shrink-0">
                  <FileSpreadsheet className="w-3.5 h-3.5 text-emerald-600" />
                </div>
                <div>
                  <p className="text-[12px] font-semibold text-foreground">Excel Workbook</p>
                  <p className="text-[10px] text-muted-foreground">6 sheets · all data</p>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-muted transition-colors text-left"
              >
                <div className="w-7 h-7 rounded-md bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center shrink-0">
                  <FileDown className="w-3.5 h-3.5 text-blue-500" />
                </div>
                <div>
                  <p className="text-[12px] font-semibold text-foreground">CSV</p>
                  <p className="text-[10px] text-muted-foreground">Content posts only</p>
                </div>
              </button>
            </div>
          </div>
