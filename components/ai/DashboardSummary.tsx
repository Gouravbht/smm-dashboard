...
const PANELS = [
  {
    ...
    icon: TrendingUp,
    bg: "bg-emerald-50 dark:bg-green-500/5 border-emerald-200 dark:border-green-500/15",
  ...
  },
  {
    ...
    icon: TrendingDown,
    bg: "bg-red-50 dark:bg-red-500/5 border-red-200 dark:border-red-500/15",
...
export function DashboardSummary() {
  ...
  return (
    <div className="mx-4 sm:mx-6 mt-4 rounded-xl border border-indigo-500/20 bg-gradient-to-br from-indigo-500/5 via-purple-500/3 to-transparent overflow-hidden">
      {/* Header */}
